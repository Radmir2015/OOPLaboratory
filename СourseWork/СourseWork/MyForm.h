...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Счет = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(5) {
				this->Column1,
					this->Column2, this->Column3, this->Column4, this->Счет
			});
			...
			// Счет
			// 
			this->Счет->HeaderText = L"Счет";
			this->Счет->Name = L"Счет";
			this->Счет->ReadOnly = true;
			// 
			// MyForm
			// 
